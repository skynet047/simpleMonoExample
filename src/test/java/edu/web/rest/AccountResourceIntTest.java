package edu.web.rest;

import edu.config.Constants;
import edu.SimpleMonoExampleApp;
import edu.domain.Authority;
import edu.domain.User;
import edu.repository.AuthorityRepository;
import edu.repository.UserRepository;
import edu.security.AuthoritiesConstants;
import edu.service.MailService;
import edu.service.dto.UserDTO;
import edu.web.rest.errors.ExceptionTranslator;
import edu.web.rest.vm.KeyAndPasswordVM;
import edu.web.rest.vm.ManagedUserVM;
...
@SpringBootTest(classes = SimpleMonoExampleApp.class)
