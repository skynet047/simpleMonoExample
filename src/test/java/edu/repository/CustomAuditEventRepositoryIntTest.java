...
import edu.config.audit.AuditEventConverter;
import edu.domain.PersistentAuditEvent;
...
import static edu.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
